...
| `PageUp`, `PageDown` | Move through terminal history by a viewport |
| Mouse wheel over terminal | Move history continuously in one-line steps |
...
`PageUp`/`PageDown` 按页浏览历史，滚轮每次移动一行。
